  ...
  return (
    <div className="relative bg-black">
      ...
      <div className="hidden md:block">
        ...
        <div className="relative bg-gradient-to-b from-black via-gray-900 to-black py-16 lg:py-20 px-6 z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1
              className={`text-8xl lg:text-9xl font-black text-white mb-6 tracking-tighter leading-none transition-all duration-1000 delay-200 ${
                mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{
            ...
            <div
              className={`text-3xl lg:text-4xl font-light text-white/90 mb-12 px-4 transition-all duration-1000 delay-400 ${
                mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{
            ...
            <div
              className={`flex flex-row gap-4 justify-center transition-all duration-1000 delay-600 ${
                mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
            >
              <button className="group px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-600 rounded-full font-bold text-lg text-white hover:shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 animate-glow">
              ...
              <button className="px-8 py-4 bg-white/10 backdrop-blur-md rounded-full font-bold text-lg text-white border-2 border-white/30 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                Learn More
              </button>
            </div>
          </div>
